...
@app.post("/create_newuser/", response_model=schema.UserResponse)
...
@app.post("/verify_stored_user/", response_model=schema.Token)
...
# --------------------------------------------------------------------------------
@app.get("/get_user/", response_model=schema.User)
